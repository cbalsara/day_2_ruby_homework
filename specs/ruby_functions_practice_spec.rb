...
def test_substring()
 ...
 assert_equal( "Sep", ninth_month_string )
  ...
  def test_volume_of_cube()
   ...
   assert_equal(523.6, volume.round(2)) 
   end
  ...
  def test_fahrenheit_to_celsius()
    celsius = fahrenheit_to_celsius(10) 
    assert_equal(-7.78, celsius.round(2))
  end 


  def test_miles_to_kilometres
      kilometres = miles_to_kilometres (5)
      assert_equal(3.1, kilometres.round(2))
  end 
end